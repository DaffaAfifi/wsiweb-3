                                    ...
                                    <form method="POST" action="insert.php">
                                        <div class="row">
                                            <div class="col mb-3">
                                                ...
                                                placeholder="Masukkan nama lengkap anda dengan gelar"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="hapus.php?id=<?php echo $data['id'];?>" onclick="return confirm('Anda yakin..?')">Hapus</a>
                                    </td>
                                </tr>
